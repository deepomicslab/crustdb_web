<template>
    <div class="flex flex-col mx-1/10 justify-start">
        ...
        <div class="mt-5 ml-15">
            ...
            <div style="box-shadow: 0 0 64px #cfd5db" class="w-310 h-200 mt-5 ml-10 mb-20" v-show="annoshow">
                <annotation />
            </div>
        </div>
        <div style="box-shadow: 0 0 64px #cfd5db" class="w-350 h-250 ml-2 mt-5 mb-20" v-show="!annoshow">
            <circo />
        </div>
        ...
        <div class="mt-20 ml-10" v-show="phageStore.phagearvf.ar.length !== 0 || phageStore.phagearvf.vf.length !== 0">
            <arvf />
        </div>
