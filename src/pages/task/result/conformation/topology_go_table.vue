...
const createColumnsVis = (): DataTableColumns<RowDataVis> => {
    return [
        ...
        {
            title() {
                return renderTooltip(h('div', null, { default: () => 'p inv' }), 'p_inv')
            },
            key: 'p_inv',
            align: 'center',
            sorter: true,
        ...
        {
            title() {
                return renderTooltip(h('div', null, { default: () => 'Hits ratio' }), 'Hits_ratio')
            },
            key: 'Hits_ratio',
            align: 'center',
            sorter: true,
...
const createColumnsFull = (): DataTableColumns<RowDataFull> => {
    return [
        ...
        {
            title() {
                return renderTooltip(h('div', null, { default: () => 'P value' }), 'P_value')
            },
            key: 'P_value',
            align: 'center',
            sorter: true,
